...
# to create atomatic one to one relationship objects
...
class User(AbstractBaseUser,PermissionsMixin):
    ...
    is_active = models.BooleanField(
        ...
        default=True,
        help_text= ugettext_lazy('Designates whether this user treated as active. Unselect this insteed of deleting accounts')
    )
